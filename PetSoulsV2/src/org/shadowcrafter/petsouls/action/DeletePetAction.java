	...
	public void run() {
		for (int i = 0; i < Integer.MAX_VALUE; i++) {
			...
			if (pet.getLives() == 0) {
				...
				Bukkit.getPlayer(pet.getOwner()).sendMessage("§8" + name + " travelled to the realm of dead souls, following your commandment. May that brave and loyal soul rest in piece");
				break;
			}
		}
	}
